...
## Algorithm
1.Detect File Encoding: Use chardet to determine the dataset's encoding.<br>
2.Load Data: Read the dataset with pandas.read_csv using the detected encoding.<br>
3.Inspect Data: Check dataset structure with .info() and missing values with .isnull().sum().<br>
4.Split Data: Extract text (x) and labels (y) and split into training and test sets using train_test_split.<br>
5.Convert Text to Numerical Data: Use CountVectorizer to transform text into a sparse matrix.<br>
6.Train SVM Model: Fit an SVC model on the training data.<br>
7.Predict Labels: Predict test labels using the trained SVM model.<br>
8.Evaluate Model: Calculate and display accuracy with metrics.accuracy_score<br>
